                ...
                <div className=" w-full">
                    <div className=' flex flex-col md:flex-row justify-between gap-4 md:gap-8'>
                        <div className=" flex items-center gap-8">
                            ...
                            <div className="">
                                <span className="text-lg md:text-xl capitalize font-semibold cursor-pointer">{content?.userInfo?.firstName} {content?.userInfo?.lastName}</span>
                    ...
                    <div className="btn-part flex gap-3 md:gap-12 items-center mt-6">
                        <Link href={`/auth/login`}>
                            <button className={`btn-item like px-2 flex gap-2 justify-center items-center  w-40 h-11 rounded-lg bg-[#0ba59313] border text-greenColor border-greenColor ${content?.isLiked ? 'shadow shadow-greenColor' : ""}  `}>
