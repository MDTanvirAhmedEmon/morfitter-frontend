    ...
    return (
        <div className="container mx-auto py-10 md:py-20">
            ...
            <div className=' grid md:grid-cols-3 gap-10 mx-5 py-8 md:py-16'>
                <Select className=' ' placeholder={<p className=" text-lg">Trainer Or Member</p>}>
                    <Select.Option value="Live">Trainer</Select.Option>
                    <Select.Option value="Recorded">Member</Select.Option>
                </Select>
                <Select className=" -mt-3 md:-mt-0" placeholder={<p className="text-lg">specialism</p>}>
                ...
                <Select className=' -mt-3 md:-mt-0' placeholder={<p className=" text-lg">Format</p>}>
